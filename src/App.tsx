...
const menuData = {
  ...
  cocktails: {
    title: "Coktails",
    items: [
      { name: "MOJITO CLÁSICO", price: "9,00 €", description: "Ron, soda, limón y menta" },
      { name: "SEX ON THE BEACH", price: "8,00 €", description: "Vodka, zumo de naranja, zumo de arándanos y zumo de melocotón" },
      { name: "LONG ISLAND ICE TEA", price: "8,00 €", description: "Ginebra, vodka, ron, tequila, triple seco y zumo de limón" },
      { name: "PIÑA COLADA", price: "8,00 €", description: "Ron, zumo de piña y leche de coco" },
      { name: "CAIPIROSKA", price: "6,00 €", description: "Vodka, zumo de limón y azúcar" },
      { name: "BLODDY MARY", price: "8,00 €", description: "Vodka, zumo de tomate, salsa inglesa, tabasco y lima" }
    ]
  },
  mocktails: {
    title: "Coktails sin alcohol y Zumos",
    items: [
      { name: "PIÑA COLADA", price: "7,00 €", description: "Zumo de piña, zumo de coco y sirope de coco" },
      { name: "SAN FRANCISCO", price: "7,00 €", description: "Zumo de piña, zumo de naranja, zumo de limón y mix de frutas" },
  ...
  hookah: {
    title: "Cachimbas",
    items: [
      { name: "BERLIN NIGHTS", price: "14,00 €", description: "Melocotón y menta" },
      { name: "BLUE YELLOW", price: "14,00 €", description: "Melón y arándanos" },
      { name: "GREEN LEON KIZZ", price: "14,00 €", description: "Lima y menta" },
      { name: "LADY KILLER", price: "14,00 €", description: "Melocotón, mango, menta y hielo" },
      { name: "LOVE 66", price: "14,00 €", description: "6 sabores y menta" },
      { name: "DOS MANZANAS", price: "14,00 €", description: "" },
      { name: "THREE ÁNGELES", price: "14,00 €", description: "Pomelo, maracuyá y hielo" },
      { name: "ESKIMO LEON", price: "14,00 €", description: "Kiwi, limón y hielo" },
      { name: "GIPSY KINGS", price: "14,00 €", description: "Melón dulce, melocotón, sandía y limón" },
      { name: "BLUE DRAGON", price: "14,00 €", description: "Fruta dragón, arándanos y bombón helado" },
      { name: "SKYFALL", price: "14,00 €", description: "Melocotón, sandía, melón y hielo" },
      { name: "HAWAI", price: "14,00 €", description: "Piña, mango y menta" },
      { name: "AMORE", price: "14,00 €", description: "Piña, crema de plátano y hielo" },
      { name: "LAVANDA SHISHA", price: "14,95 €", description: "Sabores especiales de la casa" }
    ]
  },
  food: {
    title: "Comida",
    items: [
      { name: "HAMBURGUESA DE CERDO", price: "0,00 €", description: "Cerdo, lechuga, tomate y queso" },
      { name: "HAMBURGUESA DE TERNERA", price: "0,00 €", description: "Ternera, lechuga, tomate y queso" },
      { name: "HAMBURGUESA DE POLLO", price: "0,00 €", description: "Pollo, lechuga, tomate y queso" }
    ]
  }
};
...
function App() {
      ...
      <div className="max-w-3xl mx-auto px-3 py-6">
        <header className="text-center mb-8">
          ...
          <p className="text-amber-100/70 text-base mb-4">
            Disfruta de nuestra selección de bebidas y cachimbas en un ambiente único
          </p>
        ...
        <nav className="bg-black/40 backdrop-blur-sm rounded-lg border border-white/10 overflow-hidden">
          {categoryOrder.map(key => {
            if (key === 'spirits') {
              return (
                <div key={key} className="border-b border-amber-200/20 last:border-b-0">
                  <button
                  ...
                  >
                    <span className="text-center block">{menuData[key].title}</span>
                  </button>
                  <div
                  ...
                  >
                    <div className="overflow-hidden">
                      <div className="space-y-1 py-2">
                        {Object.entries(menuData.spirits.subcategories).map(([subKey, subCategory]) => (
                          <SubMenuCategory
                            key={subKey}
  ...
  <p>Abierto todos los días de 10:00 - 00:00</p>
                    <p>Reservas: +34 614 234 758</p>        </footer>
      </div>
    </div>
  );
}
